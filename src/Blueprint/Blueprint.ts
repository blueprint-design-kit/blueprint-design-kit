...
export default class Blueprint {
    constructor(blueprintConfig: BlueprintConfig) {
        return function makeBlueprint(blueprintName?: string): BlueprintInstance {
            if (!blueprintName) {
            ...
            validateBlueprint(blueprintConfig, blueprintName);

            const bp: BlueprintConfig = Object.assign({ schema: {} }, blueprintConfig);
...
// export default function Blueprint(blueprintConfig: BlueprintConfig): (blueprintName?: string) => BlueprintInstance {

//     /**
//      * @type {import('../../index').MakeBlueprint}
//      */
//     function makeBlueprint(blueprintName) {
