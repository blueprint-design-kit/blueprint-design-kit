...
// type Blueprint = {
//     new (blueprintConfig: BlueprintConfig): (blueprintName?: string) => BlueprintInstance;
// };

// export default function Blueprint(blueprintConfig: BlueprintConfig) {

//     function makeBlueprint(blueprintName?: string): BlueprintInstance {
//         if (!blueprintName) {
//             const callerLine = new Error().stack?.split(/\n\s*at\s*/)[2];
//             const callerName = callerLine?.split(' (')[0];
//             blueprintName = callerName;
